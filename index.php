...
<body>
  <form action="traitement.php" id="inscription" method="POST">
    <fieldset id="reservation">
      ...
      <input type="checkbox" name="passSelection" id="pass1jour" onclick="choixDate1jour()">
      ...
      <input type="checkbox" name="passSelection" id="pass2jours" onclick="choixDate2jours()">
      ...
      <input type="checkbox" name"passSelection" id="passeGroupe1jour">
